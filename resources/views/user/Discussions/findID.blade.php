...
<main class="content px-3 py-4">
    ...
    <button type="button" class="btn {{$checkLike && $checkLike->is_clicked_like ? 'btn-primary' : 'btn-light'}} like-button"
        ...
        <div class="card list-answer-{{$discussion->id}}">
            <div class="card-body">
                <h5 style="font-size: 20px;" class="mb-3">2 Answers</h5>
                <div class="border-bottom mb-3 pb-2">
                    <p>tes</p>
                    <div class="d-flex justify-content-between" style="font-size: 13px;">
                        <small class="text-muted">0</small>
                        <button class="btn btn-link p-0" type="button" data-bs-toggle="collapse" data-bs-target="#replyForm" aria-expanded="false" aria-controls="replyForm">
                            Reply
                        </button>
                    </div>
                    ...
                    <div class="result-comment p-3">
                        <div class="border-bottom mb-3 pb-2">
                            ...
                            <div class="d-flex justify-content-between" style="font-size: 13px;">
                                <small class="text-muted">John Doe - 3 hours ago</small>
                            </div>
                        </div>
                        <div class="border-bottom mb-3 pb-2">
                            <p>Another sample reply here.</p>
                            <div class="d-flex justify-content-between" style="font-size: 13px;">
                                <small class="text-muted">Jane Smith - yesterday</small>
                            </div>
                        </div>
                    </div>
                </div>
