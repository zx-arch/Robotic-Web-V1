                    ...
                    <div class="col-md-12 mx-auto">
                        ...
                        <div class="card card-default">
                            <div class="card-body p-3">
                                <div class="container">
                                    <form action="{{route('admin.events.saveOnlineEvent')}}" id="form" method="post" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group highlight-addon has-success">
                                                            ...
                                                            <input type="text" name="name" id="event_name" required class="form-control" style="max-width: 90%;">
                                                        ...
                                                        <div class="form-group highlight-addon has-success mb-2">
                                                            ...
                                                            <input type="datetime-local" id="event_date" name="event_date" id="event_date" required class="form-control" min="{{date('Y-m-d\TH:i')}}" style="max-width: 90%;"><br>
                                                            <div class="invalid-feedback"></div>
                                                        </div>

                                                        <div class="form-group highlight-addon has-success">
                                                            <label for="host">Nama Host Acara <span class="text-danger">*</span></label>
                                                            <input type="text" name="host" id="host" required class="form-control" style="max-width: 90%;">
                                                            <div class="invalid-feedback"></div>
                                                        </div>

                                                        <div class="form-group highlight-addon has-success">
                                                            <label for="speakers">Pembicara <span class="text-danger">*</span></label>
                                                            <input type="text" name="speakers" id="speakers" required class="form-control" style="max-width: 90%;">
                                                            <div class="invalid-feedback"></div>
                                                        </div>

                                                        <div class="form-group highlight-addon has-success">
                                                            <label for="link_pendaftaran">Link Pendaftaran</label>
                                                            <input type="url" name="link_pendaftaran" id="link_pendaftaran" class="form-control" style="max-width: 90%;">
                                                            <div class="invalid-feedback"></div>
                                                        </div>
                                                        ...
                                                        <div class="form-group highlight-addon has-success">
                                                            ...
                                                            <input type="text" name="other_app" id="other_app" style="max-width: 90%" class="form-control" placeholder="Please specify other app">
                                                            <div class="invalid-feedback"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group highlight-addon has-success">
                                                    ...
                                                    <input type="url" name="link_online" id="link_online" class="form-control" style="max-width: 90%;">
                                                    <div class="invalid-feedback"></div>
                                                </div>

                                                <div class="form-group highlight-addon has-success">
                                                    <label for="user_access">User Akses</label>
                                                    <input type="text" name="user_access" id="user_access" class="form-control" style="max-width: 90%;">
                                                    <div class="invalid-feedback"></div>
                                                </div>

                                                <div class="form-group highlight-addon has-success">
                                                    <label for="passcode">Passcode Akses</label>
                                                    <input type="text" name="passcode" id="passcode" class="form-control" style="max-width: 90%;">
                                                    <div class="invalid-feedback"></div>
                                                </div>
                                                <div class="form-group highlight-addon has-success">
