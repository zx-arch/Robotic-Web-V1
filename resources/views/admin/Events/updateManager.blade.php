                                            ...
                                            <tbody>
                                                @foreach ($eventManager as $manager)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-warning btn-sm" href="{{route('admin.events.updateManager', ['code' => $eventCode, 'role' => 'Manager', 'id' => encrypt($manager->id)])}}" title="Update" aria-label="Update" data-pjax="0"><i class="fa-fw fas fa-edit" aria-hidden></i></a>
